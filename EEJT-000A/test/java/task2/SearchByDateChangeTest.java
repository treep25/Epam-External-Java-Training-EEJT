...
class SearchByDateChangeTest {
    ...
    void searchWhenListIsEmptyTest() {
        ...
        List<String> list = List.of("EEJT-000A\\ANSI.txt (2022-11-22 21:08:40)", "EEJT-000A\\main (2022-11-22 21:08:40)", "EEJT-000A\\README.md (2022-11-22 21:08:40)",
                "EEJT-000A\\test (2022-11-22 21:08:40)", "EEJT-000A\\test.txt (2022-11-22 21:08:40)", "EEJT-000A\\UTF8.txt (2022-11-22 21:08:40)");
        assertEquals(list, searchByDate.search(par, new ArrayList<>()));
    }
    ...
    void searchWhenListIsNotEmptyTest() {
        ...
        List<String> list = List.of(dir + "\\test.txt (2022-11-22 21:08:40)(1)");
        assertEquals(list, searchByDate.search(par, new ArrayList<>()));
    }
